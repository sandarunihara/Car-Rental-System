    ...
    <div className="w-screen h-screen flex gap-10 py-10 justify-center bg-gradient-to-r from-gray-200 to-blue-200">
      ...
      <div className="h-full w-2/4 bg-customGray rounded-lg shadow-2xl text-white">
        ...
        <div className="flex justify-between">
          <div
            onClick={handleEdit}
            className="text-white flex items-center gap-3 bg-orange-400 py-2 w-fit px-2 mt-7 ml-4 rounded-lg cursor-pointer transition-all duration-500 hover:scale-105"
          >
            <MdEdit />
            <p>Edit Profile</p>
          </div>
          {userrole === "User" ? (
            <div
              ...
              className="text-white flex items-center gap-3 bg-red-600 py-2 w-fit px-2 mt-7 mr-4 rounded-lg cursor-pointer transition-all duration-500 hover:scale-105"
            >
              <MdDelete />
              <p>Delete Profile</p>
            </div>
